...
cd cairn
npm install
npm test          # 1332 tests as of the QA round 45 fix pass. Plain node, no browser, no network.
                  # (387 from Phase 1 until R44-4, then 1239 until R45-17; re-measured each
                  #  time by running `npm run test:tap | grep '^# pass'`, never quoted.)
