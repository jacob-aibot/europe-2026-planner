...
cd cairn
npm install
npm test          # 1239 tests as of the R44-1 fix pass. Plain node, no browser, no network.
                  # (Was "387" from Phase 1 until QA R44-4; re-measured, not quoted.)
