...
| `docs/design/DIRECTIONS.md` | ~7k tok | you are picking up the visual-direction work, or Jacob has selected one | §3 alone names the four directions and their axes. **Re-measured 2026-09-12** when Direction D (the travelling day) was added beside A, B and C; the selection gate in §6 is unchanged |
