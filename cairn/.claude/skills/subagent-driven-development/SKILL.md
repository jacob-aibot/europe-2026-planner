...
[Read plan file once: cairn/docs/plans/feature-plan.md]
[Resolve workspace: scripts/sdd-workspace cairn/docs/plans/feature-plan.md — no ledger inside, fresh start]
